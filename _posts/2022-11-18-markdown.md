...
<pre>
[![Vue](/images/vue.png)](https://vuejs.org/){:target="_blank"}
</pre>

[![Vue](/image/vue.png)](https://vuejs.org/){:target="_blank"}
...
헤더 셀을 구분할 때 3개 이상의 <pre>- (hyphen/dash)</pre> 기호가 필요합니다.

헤더 셀을 구분하면서 <pre>: (Colons)</pre> 기호로 셀 (열/칸) 안에 내용을 정렬할 수 있습니다.

가장 좌측과 가장 우측에 있는 <pre>| (vertical bar)</pre> 기호는 생략 가능합니다.
...
[HEROPY Tech 블로그](https://heropy.blog/2017/09/30/markdown/){:target="_blank"}
